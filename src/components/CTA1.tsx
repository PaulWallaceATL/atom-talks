...
export default function CTA1({ dark = true }: CTA1Props) {
  return (
    <>
      <section className="cta-section py-10 py-lg-15 position-relative">
        <FloatingElements />
        
        <div className="container position-relative" style={{ zIndex: 1 }}>
          <div
            className={`rounded-5 border position-relative z-1 ${
              dark ? 'bg-dark-blue-4' : 'gradient-bg'
            }`}
          >
                ...
                <FadeInSection>
                  <div className="text-center pt-6 px-6 pt-md-10 px-md-10 pt-lg-18 px-lg-18">
                    <h2 className={`mb-6 ${dark ? 'text-white' : ''}`}>
                      ...
                      <span className={`text-${dark ? 'primary-dark' : 'primary'}`}>Intelligent AI Agent</span>?
                    </h2>
                    ...
                    <Link
                      href="/contact"
                      className={`btn btn-lg btn-${dark ? 'primary-dark' : 'primary'}`}
                    >
                      Get in Touch
                    </Link>
                    <div className="cta-image-container mt-10">
                      <svg
                        ...
                        fill="none"
                        viewBox="0 0 34 90"
                        className={`text-${dark ? 'primary-dark' : 'primary'} arrow-shape`}
                      >
                        <path
                          fill="currentColor"
